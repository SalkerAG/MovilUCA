...
<div class="container-fluid pt-5" style="margin-top: 50px;">
	<center><h2 style="padding-bottom: 50px;">Top Valorados</h2></center>
	<div class ="row" style="background-color: white;">
		
		 <div class="col-sm-12" >
	    	<table class="table ">
 			<tbody>
 				<?php foreach($valorados as $valor):?>
		     <tr class="table-light">
		     	<td></td>
		     	<th><?= bcdiv($valor->total, '1', 2);?>/5</th>
		      <td scope="row"><img src="<?php echo base_url('images/'.$valor->foto.'')?>" class="img-fluid" alt="Responsive image"height="auto" width="60px" align="left"></td>
		      <td><?= $valor->marca;?></td>
		      <td><?= $valor->modelo;?></td>
		      <td> <a href="<?= base_url().'un_movil/mov/'.$valor->id?> " class="btn btn-dark">Ver móvil</a></td> 
		    </tr>
		    <tr>
